...
public class RevertTest {
    ...
    @Test
    public void oneElementListIsRevertsToItself2() throws Exception {
        Node<String> node1 = new Node<>("1");
        assertThat(new Revert().revert2(node1), is(node1));
    }

    @Test
    public void whenRevertListThenIsReverts2() throws Exception {
        Node<String> node1 = new Node<>("1");
        Node<String> node2 = new Node<>("2");
        Node<String> node3 = new Node<>("3");
        Node<String> node4 = new Node<>("4");
        ...
        Node<String> reverted = new Revert().revert2(node1);
